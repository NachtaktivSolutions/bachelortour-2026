...
export function TourRatingCard(){
  ...
  async function reset(){
    ...
    setMessage(error?error.message:"Bewertung wurde auf 0 zurückgesetzt.");
...
function RatingLeaf({fill}:{fill:number}){
  return <svg className="rating-leaf" viewBox="0 0 120 140" aria-hidden="true"><defs><linearGradient id="leafFill" x1="0" y1="1" x2="0" y2="0"><stop offset="0" stopColor="#0b7f3d"/><stop offset=".55" stopColor="#20e36d"/><stop offset="1" stopColor="#a6ff74"/></linearGradient><clipPath id="leafClip"><path d="M60 132C57 103 57 86 58 68C49 89 36 105 20 112C25 92 34 76 48 61C32 72 18 77 4 75C15 58 30 48 49 43C34 43 23 38 14 29C31 25 45 28 56 37C53 21 55 9 60 2C66 13 68 25 65 39C76 29 90 26 106 30C97 40 86 45 72 45C91 51 105 62 116 79C100 80 85 75 72 65C85 80 94 97 99 116C82 108 70 94 62 75C63 94 64 112 65 132Z"/></clipPath></defs><path className="leaf-outline" d="M60 132C57 103 57 86 58 68C49 89 36 105 20 112C25 92 34 76 48 61C32 72 18 77 4 75C15 58 30 48 49 43C34 43 23 38 14 29C31 25 45 28 56 37C53 21 55 9 60 2C66 13 68 25 65 39C76 29 90 26 106 30C97 40 86 45 72 45C91 51 105 62 116 79C100 80 85 75 72 65C85 80 94 97 99 116C82 108 70 94 62 75C63 94 64 112 65 132Z"/><rect x="0" y={140-(140*fill/100)} width="120" height={140*fill/100} fill="url(#leafFill)" clipPath="url(#leafClip)"/><path className="leaf-vein" d="M60 126L60 20M60 58L30 93M61 61L91 98M58 47L29 57M63 49L91 59"/></svg>;
}
