...
export function TourBurnControl(){
  ...
  async function burn(){if(!confirm("Wirklich die gesamte Tour verbrennen? Danach haben normale Teilnehmer keinen Zugriff mehr auf die App."))return;try{await action("burn");setAnimating(true)}catch{}}
  ...
  return <>
    ...
    {animating&&<TourBurn mode="animation" onFinished={()=>setAnimating(false)}/>} 
  </>;
}
